...
// Returns a request for a service.  Requesters MUST bind on 'spec' and
// emit errors on 'error'.
Amino.prototype.requestService = function(service) {
  return new amino.ServiceRequest(service);
}
