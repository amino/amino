...
// Register a service, returning a spec to use.
Amino.prototype.service = function(service, cb) {
  new Service(this, service, function(err, spec) {
    cb(err, spec);
  }, this.options);
};
...
// Export our Spec agent.
amino.Agent = agent(amino);
